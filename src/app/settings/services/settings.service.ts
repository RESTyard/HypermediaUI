...
export class SettingsService {
  ...
  private mapGeneralSettingsFromStorageModel(storageModel: GeneralSettingsStorageModel): GeneralSettings {
    return new GeneralSettings({
      ...
      showEmbeddedEntityTitles: storageModel.showEmbeddedEntityTitles,
      showActionNames: storageModel.showActionNames,
      autoFollowActionLocationOnSuccess: storageModel.autoFollowActionLocationOnSuccess,
  ...
  private mapGeneralSettingsToStorageModel(appModel: GeneralSettings): GeneralSettingsStorageModel {
    return {
      ...
      showEmbeddedEntityTitles: appModel.showEmbeddedEntityTitles,
      showActionNames: appModel.showActionNames,
      autoFollowActionLocationOnSuccess: appModel.autoFollowActionLocationOnSuccess,
